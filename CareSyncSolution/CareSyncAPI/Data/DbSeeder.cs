...
namespace CareSyncAPI.Data
{
    public static class DbSeeder
    {
        ...
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            var admin = await EnsureUserAsync(userManager, "manager@caresync.local", "Manager@123", "System Admin", Roles.Manager);
        ...
        {
            foreach (var role in new[] { Roles.Manager, Roles.Doctor, Roles.Patient, Roles.Receptionist })
            {
